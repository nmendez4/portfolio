...
function About() {
    return (
        <div>
            ...
            <hr />
            <p className="card">
                My Name is Nicholas Mendez and I'm a recent web development bootcamp graduate. I currently work in a hospital and have been in the healthcare sector for the last 6 years. 
