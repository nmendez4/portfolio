    ...
    return (
        <div className="container">
            <div className="col">
                ...
                <a className="button" href="https://www.dropbox.com/s/6nbbcxtgdmk5b87/NicholasMendezResume21623%20copy.pdf?dl=0" target="_blank" rel="noreferrer" > 
                    <span className="icon">
                        <i className="download"></i>
                    </span>
                    <span className="font">Download Here!</span>
                </a>
                <img className="my-resume" src="images/NicholasMendezResume21623copy.png" alt="myresume"></img>
                <hr />
            </div>
            <div className="col">
